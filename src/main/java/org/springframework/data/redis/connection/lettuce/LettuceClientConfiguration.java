...
public interface LettuceClientConfiguration {
	...
	/**
	 * @return the optional {@link com.lambdaworks.redis.ClientOptions}.
	 */
	 ...
	 * @see com.lambdaworks.redis.AbstractRedisClient#shutdown(long, long, TimeUnit)
	 */
	...
	interface LettuceClientConfigurationBuilder {
		 ...
		 * @return {@literal this} builder.
		 * @see ClientOptions
		 * @see com.lambdaworks.redis.cluster.ClusterClientOptions
		 */
	...
	class DefaultLettuceClientConfigurationBuilder
		...
		/* (non-Javadoc)
		 * @see org.springframework.data.redis.connection.lettuce.LettuceClientConfiguration.LettuceClientConfigurationBuilder#clientResources(com.lambdaworks.redis.resource.ClientResources)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see org.springframework.data.redis.connection.lettuce.LettuceClientConfiguration.LettuceClientConfigurationBuilder#clientOptions(com.lambdaworks.redis.ClientOptions)
		 */
		@Override
